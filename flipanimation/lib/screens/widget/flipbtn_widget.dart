...
class FlipButtonWidget extends StatefulWidget {
  final Color color;
  ...
  const FlipButtonWidget({
    super.key,
    required this.color,
    required this.backgroundColor,
    required this.leftLable,
    required this.rightLable,
    this.onChange,
  });

  @override
  State<FlipButtonWidget> createState() => _FlipButtonWidgetState();
}

class _FlipButtonWidgetState extends State<FlipButtonWidget>
    ...
    return Positioned(
        ...
        child: Transform(
          ...
          child: Container(
            ...
            child: Center(
              child: Text(
                isLeft ? widget.leftLable : widget.rightLable,
                style: TextStyle(
